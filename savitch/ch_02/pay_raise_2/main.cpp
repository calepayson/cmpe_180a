...
int main() {
    ...
    std::cout << "Months of retroactive pay: ";
    int retroactive_months{};
    std::cin >> retroactive_months;
    ...
    double retroactive_pay =
        (previous_annual_salary * PAY_RAISE - previous_annual_salary) *
        retroactive_months / 12;
